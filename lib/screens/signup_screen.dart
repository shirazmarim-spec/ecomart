...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signup() async {
    ...
    if (_passwordController.text != _confirmPasswordController.text) {
      if (mounted) {
        setState(() {
          _errorMessage = TranslationConstants.getString(
            context,
            'passwordMismatch',
          );
        });
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          'message': 'Welcome! Your account is ready. Start shopping! 🛒',
        }),
      );

      if (response.statusCode != 200) {
        debugPrint('Failed to send welcome notification: ${response.body}');
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          TranslationConstants.getString(context, 'signup'),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: TranslationConstants.getString(context, 'name'),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: TranslationConstants.getString(
                      context,
                      'password',
                    ),
                    hintStyle: GoogleFonts.poppins(
